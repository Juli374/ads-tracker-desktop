...
describe('ProfilePage', () => {
  // Loose Mock typing — request/mediaUpload return shapes vary per test; the
  // explicit signatures inside vi.fn() drive type-checking at call sites.
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  let requestSpy: ReturnType<typeof vi.fn<any[], any>>;
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  let mediaUploadSpy: ReturnType<typeof vi.fn<any[], any>>;
